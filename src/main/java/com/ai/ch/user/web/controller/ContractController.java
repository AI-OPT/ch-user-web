...
public class ContractController {
	...
	public ModelAndView contractShopManagerPager(HttpServletRequest request, String userId, String userName,
			String custName) {
		long startTime = System.currentTimeMillis();
	...
	public ModelAndView contractSupplierDetailPager(HttpServletRequest request, String userId, String userName,
			String custName) {
	...
	public ModelAndView contractShopDetailPager(HttpServletRequest request, String userId, String userName,
			String custName) {
	...
	public ModelAndView addShopContractInfo(HttpServletRequest request, ContactInfoRequest contractInfo,
		...
		try {
			...
			for (CmCustFileExtVo extVo : list) {
				if (multiScanFile.getSize() > 0 && !"".equals(extVo.getInfoName())
						&& ChWebConstants.SCAN_CONTRACT_SHOP.equals(extVo.getInfoItem())) {
					if (extVo.getInfoName().contains(".PNG") || extVo.getInfoName().contains(".JPG")
							|| extVo.getInfoName().contains(".png") || extVo.getInfoName().contains(".jpg")) {
				...
				if (multiElectronicFile.getSize() > 0 && !"".equals(extVo.getInfoName())
						&& ChWebConstants.ELECTRONIC_CONTRACT_SHOP.equals(extVo.getInfoItem())) {
					if (extVo.getInfoName().contains(".PNG") || extVo.getInfoName().contains(".JPG")
							|| extVo.getInfoName().contains(".png") || extVo.getInfoName().contains(".jpg")) {
						String idpsns = "ch-user-web-idps";
						IImageClient im = IDPSClientFactory.getImageClient(idpsns);
	...
	public ModelAndView addSupplierContractInfo(HttpServletRequest request, ContactInfoRequest contractInfo,
		...
		try {
			...
			for (CmCustFileExtVo extVo : list) {
				if (multiScanFile.getSize() > 0 && !"".equals(extVo.getInfoName())
						&& ChWebConstants.SCAN_CONTRACT_SUPPLIER.equals(extVo.getInfoItem())) {
					if (extVo.getInfoName().contains(".PNG") || extVo.getInfoName().contains(".JPG")
							|| extVo.getInfoName().contains(".png") || extVo.getInfoName().contains(".jpg")) {
						String idpsns = "ch-user-web-idps";
						IImageClient im = IDPSClientFactory.getImageClient(idpsns);
				...
				if (multiElectronicFile.getSize() > 0 && !"".equals(extVo.getInfoName())
						&& ChWebConstants.ELECTRONIC_CONTRACT_SUPPLIER.equals(extVo.getInfoItem())) {
					if (extVo.getInfoName().contains(".PNG") || extVo.getInfoName().contains(".JPG")
							|| extVo.getInfoName().contains(".png") || extVo.getInfoName().contains(".jpg")) {
						String idpsns = "ch-user-web-idps";
						IImageClient im = IDPSClientFactory.getImageClient(idpsns);
