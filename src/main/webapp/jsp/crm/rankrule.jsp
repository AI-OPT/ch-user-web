...
<script id="rankRuleImpl" type="text/x-jsrender">
	{{for id}}
		<tr>
			...
			<td class="text-l pl-10" style="white-space:nowrap"><span class="btn-upload"><p class='f-14'>图片名称 :<input class="int-text int-mini" disabled="disabled" id="picName{{:index}}" type="text" style="border: none;background:none;width:60px;"><input type="hidden" name="list[{{:index-1}}].rankLogo" id="rankLogo{{:index}}"><input type="hidden" name="rankName{{:index}}" id="rankName{{:index}}">
