...
<body>
	...
	{{for}}
		<tr>
			...
			<td class="text-l pl-10" style="white-space:nowrap"><span class="btn-upload"><p class="f-14">图片名称:<input class="int-text int-mini" id="picName{{:rank}}" value="" type="text" readonly="readonly" style="border:none;background:none;width:60px;font-weight:400;"><input type="hidden" id=rankLogo{{:rank}} name="rankLogo{{:rank}}"><input type="hidden" id=rankName{{:rank}} name="rankName{{:rank}}">
