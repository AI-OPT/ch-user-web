							...
							<div class="form-label" style="margin-bottom: 20px ">
					           	<ul>
					                <li class="col-md-6" style="width: 40%">
					                    <p class="word" style="font-size: 18px;margin-left: 30px">用户名:</p>
					                    <p>${userName }</p>
					                </li>
					                <li  class="col-md-6">
					                    <p class="word" style="font-size: 18px">企业名称:</p>
					                    <p>${custName}</p>
					                </li>  
					            </ul>
				         	...
				         	<div class="form-label">
				         		 <ul>
					                <li  class="col-md-6" style="border-bottom:1px  solid #e7e7e7;padding-bottom: 10px;width: 98%;margin-left: 30px">
					                    <p class="word" style="font-size: 18px">计算周期设置</p>
					                </li>  
					            </ul>
				         	</div>
					   	<!--查询结束-->   
						    	...
						    	<ul style="margin-bottom: 20px">
									<li>
									 ...
									 <input type="hidden" id="custName" value="${custName }"/>
									  ...
									  <input type="radio" class="radio-1" id="billingCycle" value="Q" id="billingCycle" name="periodType">
