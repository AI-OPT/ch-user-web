                                ...
                                <div class="table-responsive clearfix">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>企业营业执照注册名称</td>
                                            <td>已上传</td>
                                            <td  id="operation"><a href="${_base}/contract/contractSupplierManagerPager?userId=2">管理</a><a href="#">查看</a></td>
                                        </tr>
                                        <tr>
                                        	<td>xionger</td>
                                            <td>企业营业执照注册名称</td>
                                            <td>未上传</td>
                                            <td  id="operation"><a href="${_base}/contract/contractSupplierManagerPager?userId=3">管理</a><a href="#">查看</a></td>
                                        </tr>
                                         <tr>
                                        	<td>xionger</td>
                                            <td>企业营业执照注册名称</td>
