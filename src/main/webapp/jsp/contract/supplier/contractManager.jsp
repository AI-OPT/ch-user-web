					 	...
					 	<!--form-->
					 	 	<div class="form-label pl-40">
						    	<ul>
									...
									<li><input type="text" class="int-text int-medium" placeholder="请输入账号" value="${contactInfo.contractCode }"/></li>
								</ul>
								...
								<ul>
									...
									<li><input type="text" class="int-text int-medium" placeholder="请输入名称" value="${contactInfo.contractName }"/></li>
								</ul>

								<ul>
									<li>
										<p class="word"><b class="red">*</b>开始时间:</p>
										<p><input type="text" class="int-text int-medium"/><i class="icon-calendar"></i></p>
									</li>
									<li>
								...
								<ul>
									<li class="form-btn" >
										<input type="button" class="biu-btn border-green btn-xlarge  radius"  style="margin-left: 60%"  value="成功">	
									</li>
								</ul>
