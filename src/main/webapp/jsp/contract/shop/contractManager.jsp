								...
								<ul>
									<li>
										...
										<span class="btn-upload">
							               ...
							               <input type="hidden" value="40001" name="list[0].infoItem">
									...
									<li>
										<p class="word">电子版合同:</p>
										 ...
										 <span class="btn-upload">
								             ...
								             <input type="hidden" id="electronicFileInfoType" value="40" name="list[1].infoType">
								             <input type="hidden" id="electronicFileInfoItem" value="40002" name="list[1].infoItem">
