				...
				<div class="col-lg-12">
					...
					<div class="main-box clearfix">
						...
						<div class="form-label">
							...
							<ul>
								<li><label style="display: inline-block; font-size: 18px">企业执照</label><span
							...
							<ul>
								<li><label style="display: inline-block; font-size: 18px">税务登记证</label><span
									style="display: inline-block; border-bottom: 1px solid #000; width: 900px; margin-left: 10px; margin-bottom: 5px"></span>
								</li>
							</ul>
							<ul>
							...
							<ul>
								...
								<li>
									<p class="word" style="font-size: 16px">${organizationCode }</p>
								</li>
							</ul>
							<ul>
								<li>
							...
							<ul>
								...
								<li>
									<p class="word" style="font-size: 16px">${bankName }</p>
								</li>
							</ul>
							<ul>
								<li>
								...
								<li>
									<p class="word" style="font-size: 16px">${bankAccount }</p>
								</li>
							</ul>
							<ul>
								<li>
							...
							<ul>
								...
								<li>
									<p class="word" style="font-size: 16px">${brandNameType }</p>
								</li>
							</ul>
							<ul>
								<li>
								...
								<li>
									<p class="word" style="font-size: 16px">${brandNameCh }</p>
								</li>
							</ul>
							<ul>
								<li>
								...
								<li>
									<p class="word" style="font-size: 16px">${brandNameEn }</p>
								</li>
							</ul>
							<ul>
								<li>
							...
							<ul>
								<li><input type="button"
									class="biu-btn  btn-primary btn-blue btn-medium ml-10 btn-green"
									value="通过" onclick="pager._passAudit('${userId}');"
									style="margin-left: 60%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								</li>

								<li><input type="button"
									class="biu-btn  btn-primary btn-blue btn-medium ml-10 btn-red"
									value="拒绝" onclick="pager._rejectAudit('${userId}');">
								</li>
							</ul>
						</div>
					</div>
