define('app/jsp/crm/rankrule-edit', function (require, exports, module) {
    ...
    var RankRuleEditPager = Widget.extend({
    	...
    	_initTable:function(){
    		...
    		var count_ = count-1;
    		//第一行
    		var htmlOutput ="<tr><td><p class='f-14' style='font-weight:400;'>等级 1: <input type='text' value='0' class='int-text int-mini' id='min1' style='border:1px;border-bottom-style:none;border-top-style:none;border-left-style:none;border-right-style:none;' name='list[0].minScore' readonly='readonly'> - <input type='hidden' value='1' name='list[0].rank'><input class='int-text int-mini' name='list[0].maxScore' id='max1' value='"+result[0].maxScore+"' type='text' onblur='"+"pager._changeValue(1)'>分<input type='text' id='rankMsg1' style='display:none;color:red'></p></td>";
            ...
            //最后一行
            var htmlOutputEnd ="<tr><td><p class='f-14' style='font-weight:400;'>等级 "+count+" :  <input class='int-text int-mini' name='list["+count_+"].minScore' id='min"+count+"' type='text' value='"+result[count_].minScore+"' readonly='readonly' style='border:1px;border-bottom-style:none;border-top-style:none;border-left-style:none;border-right-style:none;'> 分以上</p><input type='hidden' value='999999999999999' name='maxScore'><input type='hidden' value='"+count+"' id='max"+count+"' name='list["+count_+"].rank' onblur='"+"changeValue("+count+")'></td>";
    	...
    	_changeTable:function(){
    		...
    		//I am drunk
    		var count_=count-1;
    		var htmlOutput ="<tr><td><p class='f-14' style='font-weight:400;'>等级 1: <input class='int-text int-mini' readonly='readonly' type='text' name='list[0].minScore' id='min1' value='0' style='border:1px;border-bottom-style:none;border-top-style:none;border-left-style:none;border-right-style:none;'><input type='hidden' name=list[0].rank value='1'> - <input class='int-text int-mini' name='list[0].maxScore' id='max1' type='text' onblur=\""+"pager._changeValue('1')"+"\">分<input type='text' style='display:none;color:red' id='rankMsg1'></p></td>";
