define('app/jsp/crm/rankrule-edit', function (require, exports, module) {
    ...
    var RankRuleEditPager = Widget.extend({
    	...
    	_initTable:function(){
            ...
            htmlOutput+="<td style='white-space:nowrap'><p class='f-14'>等级名称 :  <input class='int-text int-mini' name='list[0].rankName' type='text' value='"+result[0].rankName+"' id='name1' onblur='"+"pager._valideName(1)' maxlength='40'><input type='text' style='display:none;color:red' id='nameMsg1'></p></td>";
    	...
    	_changeTable:function(){
            ...
            htmlOutput+="<td style='white-space:nowrap'><p class='f-14'>等级名称 :  <input class='int-text int-mini' name='list[0].rankName' id='name1' type='text' onblur=\""+"pager._valideName('1')"+"\" maxlength='40'><input type='text' id='nameMsg1' style='display:none;color:red'></p></td>";
            ...
            htmlOutput += template.render(json);
             ...
             htmlOutput+="<td style='white-space:nowrap'><p class='f-14'>等级名称 :  <input class='int-text int-mini' name='list["+count_+"].rankName' id='name"+count+"' type='text' onblur=\""+"pager._valideName('"+count+"')\" maxlength='40'><input type='text' id='nameMsg"+count+"' style='display:none;color:red'></p></td>";
