define('app/jsp/crm/rankrule-edit', function (require, exports, module) {
    ...
    var RankRuleEditPager = Widget.extend({
    		...
    		$.ajax({
    	        ...
    	        success: function(data) {
    	        	if(data.responseHeader.resultCode='000000'){
    		            ...
    		            htmlOutput+="<input type='file' class='int-file1' id='img1' name='img1' onchange=\""+"pager._imgName('1')\"/></span><span id='imgInfo1' style='color:grey;'>gif/jpg/jpeg/png</span><input type='text' id='picErr1' style='display:none;color:red;font-size:14px'></p></td></tr>";
    		            //最后一行
    		    		...
    		    		htmlOutputEnd+="<input type='file' class='int-file1' id='img"+count+"' name='img"+count+"' onchange=\""+"pager._imgName("+count+")\"/></span><span id='imgInfo"+count+"' style='color:grey;'>gif/jpg/jpeg/png</span><input type='text' id='picErr"+count+"' style='display:none;color:red;font-size:14px'></p></td></tr>";
    		    		if(count>2){
    	...
    	_changeTable:function(){
            ...
            htmlOutput+="&nbsp;<input type='button' class='btn-primary btn-default btn-medium' value='浏览文件'/>";
            htmlOutput+="<input type='file' class='int-file1' id='img1' name='img1' onchange=\""+"pager._imgName('1')\"/></span><span id='imgInfo1' style='color:grey;'>gif/jpg/jpeg/png</span><input type='hidden' id='idpsId1' name='list[0].idpsId'><input type='text' id='picErr1' style='display:none;color:red;font-size:14px'></p></td></tr>";
    		if(count>2){
    		var json = '{result:[';
            ...
            htmlOutput+="&nbsp;<input type='button' class='btn-primary btn-default btn-medium' value='浏览文件'/>";
            htmlOutput+="<input type='file' class='int-file1' id='img"+count+"' name='img"+count+"' onchange=\""+"pager._imgName('"+count+"')\"/></span><span id='imgInfo"+count+"' style='color:grey;'>gif/jpg/jpeg/png</span><input type='hidden' id='idpsId"+count+"' name='list["+count_+"].idpsId'><input type='text' id='picErr"+count+"' style='display:none;color:red;font-size:14px'></p></td></tr>";
            $("#TBODY_RANKRULE").html(htmlOutput);
            $("#rankRegion").val(count);
    	},
