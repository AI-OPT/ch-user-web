define('app/jsp/crm/rankrule-edit', function (require, exports, module) {
    ...
    var RankRuleEditPager = Widget.extend({
    	...
    	_changeTable:function(){
            ...
            htmlOutput+="<td class='text-l pl-10' style='white-space:nowrap'><span class='btn-upload'><p class='f-14'>图片名称:<input class='int-text int-mini' disabled='disabled' id='picName1' style='border:none;background:none;width:60px;font-weight:400;'><input type='hidden' name='list[0].rankLogo' id='rankLogo1'><input type='hidden' name=rankName1' id='rankName1'>";
            htmlOutput+="<input type='button' class='biu-btn btn-primary btn-blue btn-auto ml-10' value='浏览文件'/>";
            ...
            htmlOutput+="<td class='text-l pl-10' style='white-space:nowrap'><span class='btn-upload'><p class='f-14'>图片名称:<input class='int-text int-mini' disabled='disabled' id='picName"+count+"' type='text' style='border: none;background:none;width:60px;font-weight:400;'><input type='hidden' name='list["+count_+"].rankLogo' id='rankLogo"+count_+"'><input type='hidden' name='rankName"+count+"' id='rankName"+count+"'>";
            htmlOutput+="<input type='button' class='biu-btn btn-primary btn-blue btn-auto ml-10' value='浏览文件'/>";
