define('app/jsp/crm/rankrule', function (require, exports, module) {
    ...
    var RankRulePager = Widget.extend({
    	...
    	_initTable:function(){
    		...
    		//I am drunk
    		var count_=count-1;
    		var htmlOutput ="<tr><td style='white-space:nowrap'><p class='f-14' style='font-weight:400;'>等级 1: <input class='int-text int-mini' readonly='readonly' type='text' name='list[0].minScore' id='min1' value='0' style='border:1px;border-bottom-style:none;border-top-style:none;border-left-style:none;border-right-style:none;width:60px'><input type='hidden' name=list[0].rank value='1'> - <input class='int-text int-mini' name='list[0].maxFee' id='max1' type='text' onblur=\""+"pager._changeValue('1')"+"\" maxlength='15' onkeydown='return doit()' style='width:60px'>分<input type='text' style='display:none;color:red' id='rankMsg1'></p></td>";
