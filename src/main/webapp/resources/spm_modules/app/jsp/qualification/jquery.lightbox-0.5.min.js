...
(function($) {
	$.fn.lightBox = function(settings) {
		...
		function _set_interface() {
			...
			+ settings.imageLoading+ '"></a></div></div></div><div id="lightbox-container-image-data-box"><div id="lightbox-container-image-data"><div id="lightbox-image-details"><span id="lightbox-image-details-caption"></span><span id="lightbox-image-details-currentNumber"></span></div></div></div></div>');
			...
			$('#jquery-lightbox').css({
				top : /*arrPageScroll[1]-200 + (arrPageSizes[3] / 10)*/0,
			...
			$(window).resize(function() {
				...
				var arrPageScroll = ___getPageScroll();
				$('#jquery-lightbox').css({
					top : 0/*arrPageScroll[1]-200 + (arrPageSizes[3] / 10)*/,
					left : arrPageScroll[0]
				});
			});
		}
		...
		function ___getPageScroll() {
			...
			if (self.pageYOffset) {
				...
				//debugger;
				//火狐+谷歌
				/*yScroll = window.parent.document.documentElement.scrollTop+window.parent.document.body.scrollTop;;
